                                                                    ...
                                                                    <div class="card-body">
                                                                        <form method="post" action="withdrawal-request">
                                                                            <div class="form-group row">
                                                                                <label for="bank_name" class="col-md-3 col-form-label"><b>Tên ngân hàng</b></label>
                                                                                <div class="col-md-9">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="account_number" class="col-md-3 col-form-label"><b>Số tài khoản</b></label>
                                                                                <div class="col-md-9">
                                                                                    <input id="account_number" name="account_number" placeholder="Nhập số tài khoản" type="text" class="form-control" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label for="amount" class="col-md-3 col-form-label"><b>Số tiền</b></label>
                                                                                <div class="col-md-9">
                                                                                    <input id="amount" name="amount" placeholder="Nhập số tiền" type="number" step="0.01" class="form-control" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label for="transaction_details" class="col-md-3 col-form-label"><b>Nội dung giao dịch</b></label>
                                                                                <div class="col-md-9">
                                                                                    <textarea id="transaction_details" name="transaction_details" placeholder="Nhập nội dung giao dịch" class="form-control" rows="3" required></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <div class="col-md-12 text-center mt-4">
                                                                                    <button type="submit" class="btn btn-success">
                                                                                        <i class="fa fa-check"></i> Gửi yêu cầu
                                                                                    </button>
                                                                                </div>
                                                                            </div>
                                                                        </form>
