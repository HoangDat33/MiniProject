...
<html lang="en">
    <head>
        ...
        <!-- site metas -->
        <title>The Card Shop - Danh sách báo cáo</title>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding: 7px 10px">
                                                                            <a onclick="deleteReport(<%=dataReport.get(i).getId() %>)" class="btn btn-danger" style="color: white;display: inline-block;" >Xóa báo cáo</a>
                                                                        </td>
                                                                    </tr>
                                                                    <% }else{ %>
                                                                    <tr>
    ...
    <script>
                                function deleteReport(iddelete) {
                                    // Chuyển hướng đến servlet với idorder là tham số
                                    const url = "deletereport?id=" + iddelete;
