                                                                            ...
                                                                            <span>
                                                                                ...
                                                                                <td style="display: flex; gap: 5px">
                                                                                    <c:if test="${request.status == 'PENDING'}">
                                                                                        <form action="withdrawal-admin" method="post">
                                                                                            <input type="hidden" name="action" value="APPROVED"/>
                                                                                            <input type="hidden" name="requestId" value="${request.id}"/>
                                                                                            <button onclick="return confirm('Are you sure to approve it?')" class="btn btn-success">Approve</button>
                                                                                        </form>
                                                                                        <form action="withdrawal-admin" method="post">
                                                                                            <input type="hidden" name="action" value="REJECTED"/>
                                                                                            <input type="hidden" name="requestId" value="${request.id}"/>
                                                                                            <button onclick="return confirm('Are you sure to reject it?')" class="btn btn-danger">Reject</button>
                                                                                        </form>
                                                                                    </c:if>
                                                                                    <c:if test="${request.status != 'PENDING'}">
                                                                                        <span class="badge badge-secondary">Đã xử lí</span>
                                                                                    </c:if>
                                                                                </td>
                                                                                </tr>
                                                                            </c:forEach>
