                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center; padding: 12px 5px"><%=dataComment.get(i).getCreatedAt() %></td>
                                                                    <td style="width: 170px; padding: 7px 15px">
                                                                        ...
                                                                        <a href="deletefeedback?id=<%= dataComment.get(i).getCommentID() %>" class="btn btn-danger" style="color: white;display: inline-block;" >Xóa</a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                                <%}%>
