<%-- 
    Document   : manageuserregistergetnotification
    Created on : Aug 1, 2024, 8:26:12 PM
    Author     : Bravo 15
--%>
...
<html lang="en">
    <head>
        ...
        <!-- site metas -->
        <title>The Card Shop - Quản lý gửi thông báo</title>
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-light">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h5 class="card-title mb-0">Quản lý người dùng đăng kí nhận thông báo</h5>
                                                <form class="form-inline" action="searchuserregister" method="GET">
                                                ...
                                                <table class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center; font-weight: bold; font-family: sans-serif; font-size: 15px;">Lời nhắn</th>
                                                    ...
                                                    <tbody>
                                                        <%List<RegisterNotification> dataRn = (List<RegisterNotification>) request.getAttribute("dataRn");
                                                            if (dataRn != null) {
                                                            for (RegisterNotification n : dataRn) {%>
                                                    ...
                                                    <td class="d-flex justify-content-start align-items-center">
                                                        <%if(n.getIsDelete() == true){%>
                                                        <a href="#" class="btn btn-info btn-sm text-light mr-2" onclick="acceptUser(<%= n.getId()%>)">Đồng ý</a>
                                                        <%}else{%>
                                                        <a href="#" class="btn btn-danger btn-sm" onclick="rejectUser(<%= n.getId()%>)">Từ chối</a>     
                                                        <%}%>
                                                    </td>
                                                    </tr>
                                                    <%}}%> 
    ...
    <script>
                                                            ...
                                                            function acceptUser(id) {
                                                                $.ajax({
                                                                    url: '/TheCardWebsite/acceptuserregister',
                                                                    type: 'POST',
                                                                    data: {
                                                                        id: id
                                                                    },
                                                                    ...
                                                                    error: function (xhr, status, error) {
                                                                        console.error('Lỗi khi chấp nhận đăng kí:', error);
                                                                        $('#orderDetailsContent').html('Không thể chấp nhận đăng kí lúc này. Vui lòng thử lại sau.');
                                                                    }
                                                                });
                                                            }
                                                            ...
                                                            function rejectUser(id) {  
                                                                $.ajax({
                                                                    url: '/TheCardWebsite/rejectuserregister',
                                                                    type: 'POST',
                                                                    data: {
                                                                        id: id
                                                                    },
