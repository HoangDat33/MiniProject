...
public class User {
    ...
    public User(int ID, String FirstName, String LastName, String Email, String Phone, double Balance, Role Role, Boolean IsMember, Boolean GetNotifications, Date CreatedAt, Date UpdatedAt, Date DeletedAt, Boolean IsDelete, int DeletedBy) {
        this.ID = ID;
        this.FirstName = FirstName;
        this.LastName = LastName;
        this.Email = Email;
